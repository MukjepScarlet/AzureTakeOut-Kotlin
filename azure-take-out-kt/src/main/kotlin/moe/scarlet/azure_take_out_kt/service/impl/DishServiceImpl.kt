...
class DishServiceImpl(
    ...
    override fun countByCategoryId(categoryId: Long) = dishMapper.selectCount {
        Dish::categoryId eq categoryId
    }
    ...
    override fun update(dishDTO: DishDTO) {
        ...
        dishMapper.updateById(Dish(id!!, name, categoryId, price, image, description, status))
    ...
    override fun list(categoryId: Long): List<Dish> = dishMapper.selectList {
        Dish::categoryId eq categoryId
    }
