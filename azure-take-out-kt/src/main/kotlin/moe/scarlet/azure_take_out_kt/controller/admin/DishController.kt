...
class DishController(
    ...
    @GetMapping("/page")
    fun query(dishPageQueryDTO: DishPageQueryDTO): JsonResult<QueryResult<Dish>> {
    ...
    @GetMapping("/{id}")
    fun getById(@PathVariable id: Long): JsonResult<DishVO> = JsonResult.success(dishService.getByIdWithFlavor(id))
